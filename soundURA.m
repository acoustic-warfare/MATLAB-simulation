...
sig1_ang = [0;0];    % Angel of signal, [AzimuthAngle; ElevationAngle]
sig2_ang = [-90;-90];    % Angel of signal, [AzimuthAngle; ElevationAngle]
...
% sampling
sample_rate = 8192; %Sample rate of 10kHz
